	...
	function woothemes_add_admin() {
   	...
   	------------------------------------------------------------*/
		...
		if ( isset( $_REQUEST['page'] ) ) {
			...
			$_page = mysqli_real_escape_string($link, strtolower( trim( strip_tags( $_REQUEST['page'] ) ) ) );
			...
			if ( isset( $_REQUEST['woo_save'] ) ) {
				...
				$_action = mysqli_real_escape_string($link, strtolower( trim( strip_tags( $_REQUEST['woo_save'] ) ) ) );
