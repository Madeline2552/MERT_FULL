...
<?php woo_top(); ?>
<div id="wrapper">
	<?php if ( !is_user_logged_in() ) { ?><a href="https://www.rochester.edu/mert/login/" title="Login" id="member-meta">Member Login</a><?php } else {
	?><span id="member-meta">Welcome, <?php global $current_user; get_currentuserinfo(); echo $current_user->display_name; ?> | <a href="/mert/dashboard/" title="Go to the Member Dashbard">Dashboard</a> | <a href="<?php echo wp_logout_url(); ?>" title="Logout">Logout</a></span><?php } ?>
	<?php woo_header_before(); ?>
    
	<div id="header" class="col-full">
 		
		<?php woo_header_inside(); ?>
       <?php include_once('header_mert.php'); /*
		<div id="logo">
		<?php
