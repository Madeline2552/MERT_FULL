	...
	static function data_export_callback() {
  	...
  	static function captcha_settings_callback() {
        ...
        <br />
       	...
       	<strong><?php _e( 'Google reCAPTCHA', 'si-contact-form' ); ?></strong> <br /><br />
		...
		<label for="<?php echo self::$form_option_name; ?>[recaptcha_enable]"><?php _e( 'Enable reCAPTCHA.', 'si-contact-form' ); ?></label>
		...
		<?php _e( 'Limits spam by requiring that the user pass a Google reCAPTCHA test before posting. Protect your website from spam and abuse while letting real people pass through with ease. Requires registering free Google reCAPTCHA keys for this site.', 'si-contact-form' ) ?>
		</div>
		<br />
		...
		if ( self::$form_options['recaptcha_enable']  == 'true' && (self::$global_options['recaptcha_public_key'] == '' || self::$global_options['recaptcha_secret_key'] == '') ) {
			...
			echo __( 'Warning: reCAPTCHA API key(s) missing. Enabling reCAPTCHA on the Security tab requires the keys to also be set.', 'si-contact-form' );
			echo "</div>\n";
		}
		?>

		<label for="recaptcha_public_key"><?php _e( 'reCAPTCHA Site Key', 'si-contact-form' ); ?>:</label>
        ...
        <label for="recaptcha_secret_key"><?php _e( 'reCAPTCHA Secret Key', 'si-contact-form' ); ?>:</label>
        ...
        <?php _e( '<a href="https://www.google.com/recaptcha/intro/" target="_new">Get reCAPTCHA keys for your site here</a>', 'si-contact-form' ); ?><br />
		...
		<?php _e( 'Makes the Secue Image CAPTCHA or the Google reCAPTCHA image smaller.', 'si-contact-form' ) ?>
		</div>
		<br />
