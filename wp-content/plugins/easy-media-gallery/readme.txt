...
Tags: gallery, image gallery, photo album, free gallery, best gallery plugin, gallery image, photo gallery, responsive gallery, wordpress gallery, widget, photo, images
...
Gallery & Photo Album plugin will help you more easily create image gallery, photo album, portfolio and slider image.

== Description ==

**Gallery** enables you to create several media such as galleries, photo albums, portfolio and also simple picture to an image slider, image carousel, youtube video, vimeo video and audio playlist. This [gallery](https://ghozylab.com/plugins/easy-media-gallery-pro/demo/best-gallery-grid-galleries-plugin/ "gallery") plugin represents a perfect solution for your website gallery.
...
This gallery plugin is very customizable that allow you to adjust colors, positions, grid, media sizes, hover effect and much more with one easy control panel. That easy control panel for experts it would save your time, and for you who do not have more knowledge about web programming, of course this plugin will allow you to manage your gallery and portfolio much more easily.
